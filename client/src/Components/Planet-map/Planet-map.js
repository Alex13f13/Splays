    ...
    return (
        <div className='no-scroll'>
            ...
            <div ref={divRef} className='scrollable-div'>
                <img className='map-background' src='https://res.cloudinary.com/dwxuz6cft/image/upload/v1639352242/splays_app/background_images/planet_map_bg_main_grid_vwanxu.jpg' alt='planetMap bg main grid vwanxu.jpg' />
