        ...
        <div className='ships-main-container'>
          <div className='ships-list'>
            ...
            {user.ships.map((elm, idx) => {
              return (
                <div key={elm._id} className={selectedIndex === idx ? 'ships-card-clicked' : 'ships-card'} style={{ animation: `ships-card-creation 1s ${idx * 0.2}s forwards` }} onClick={() => shipChange(elm.image, idx)} key={elm.name}>
                  <div>
